...
if (
	...
	camera.rotation.fromArray(
		savedCameraState.rotation,
	)
	camera.zoom =
		savedCameraState.zoom
} else {
	resetCamera()
}
...
for (
	...
	tempVec.applyMatrix4(
		lineSegments.matrixWorld,
	)
	vectors.push(
		tempVec.clone(),
	)
